 ...
 * @access public
 */
class Logistics_Provider_Customize_Section_Pro extends WP_Customize_Section {
	 ...
	 * @var    string
	 */
	public $type = 'logistics-provider';
...
class logistics_provider_Button extends WP_Customize_Section {
